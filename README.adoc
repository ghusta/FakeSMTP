...
[link=https://github.com/ghusta/FakeSMTP/actions/workflows/maven-build.yml]
image::https://github.com/ghusta/FakeSMTP/actions/workflows/maven-build.yml/badge.svg[]
